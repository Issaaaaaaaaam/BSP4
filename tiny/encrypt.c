...
void initialization_c(const unsigned char *key, const unsigned char *iv, unsigned int *state)
{
        int i;
...
void process_ad_c(const unsigned char *k, const unsigned char *ad, unsigned long long adlen, unsigned int *state)
{
